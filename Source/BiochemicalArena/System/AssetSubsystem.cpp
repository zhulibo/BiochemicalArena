...
void UAssetSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	SystemSound = LoadObject<USystemSound>(nullptr, TEXT("/Script/BiochemicalArena.CharacterSound'/Game/Audio/Footsteps/DA_CharacterSound.DA_CharacterSound'"));

	CharacterSound = LoadObject<UCharacterSound>(nullptr, TEXT("/Script/BiochemicalArena.SystemSound'/Game/Audio/DA_SystemSound.DA_SystemSound'"));
